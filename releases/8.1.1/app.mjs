...
initVisionUI();initHabits();initSpeech();
...
function createSpeech(){return new SpeechDriver({synth:window.speechSynthesis,Utterance:window.SpeechSynthesisUtterance,setTimer:setTimeout,clearTimer:clearTimeout,onState:()=>renderSpeech()});}
