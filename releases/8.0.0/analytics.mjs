...
export const FEATURES = {
 water:['Вода','hand','Подтверждение объёма; ёмкость у рта; защита от повтора'],
 ...
 posture:['Положение головы','face','Калибровка по серии кадров; отклонение; задержка предупреждения'],
...
export function faceMetrics(lm) {
 ...
 return {eyeRatio:(left+right)/2,eyeWidth:eyes,width,height,noseY:lm[1].y,
