...
function createSpeech(){return new RecordedSpeechDriver({media:document.getElementById('speech-player'),audioBase:'./releases/8.1.2/audio/',synth:window.speechSynthesis,Utterance:window.SpeechSynthesisUtterance,setTimer:setTimeout,clearTimer:clearTimeout,onState:()=>renderSpeech()});}
