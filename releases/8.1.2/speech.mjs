...
export class SpeechDriver {
 constructor({synth,Utterance,setTimer=setTimeout,clearTimer=clearTimeout,onState=()=>{}}){Object.assign(this,{synth,Utterance,setTimer,clearTimer,onState});this.current=null;this.timer=null;this.enabled=false;this.status='off';this.message='Нажмите «Включить голос и проверить»';this.lastText='';this.voiceURI='';}
